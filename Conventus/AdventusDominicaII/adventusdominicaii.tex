...
\noindent De Isaia \textit{Pro}\textbf{phé}ta.
...
\textusEtTranslatio{
  ...
  spíritus sapiéntiæ et \textit{intel}\textbf{léc}tus,~\grestar{}
  spíritus consílii et forti\textbf{tú}dinis,~\gredagger{}
  spíritus sciéntiæ et \textit{pie}\textbf{tá}tis;~\grestar{}
  Et replébit eum spíritus timó\textit{ris} \textbf{Dó}mini.
  Non secúndum visiónem oculórum iudicábit
  neque secúndum audítum áurium \textbf{ár}guet;~\gredagger{}
  Sed iudicábit in iustí\textit{tia} \textbf{páu}peres,~\grestar{}
  et árguet in æquitáte pro mansué\textit{tis} \textbf{ter}ræ.
}{\trMatLecI}{10cm}
...
\textusEtTranslatio{
  Et percútiet terram virga \textit{oris} \textbf{su}i,~\grestar{}
  et spíritu labiórum suórum interfíci\textit{et} \textbf{ím}pium.
  Et erit iustítia cíngulum lum\textit{bórum} \textbf{e}ius,~\grestar{}
  et fides cinctórium re\textit{num} \textbf{e}ius.
  Habitábit lupus cum agno,
  et pardus cum hædo accu\textbf{bá}bit;~\gredagger{}
  vítulus, et leo, et ovis, simul \textit{mora}\textbf{bún}tur,~\grestar{}
  et puer párvulus miná\textit{bit} \textbf{e}os.
  Vítulus et ursus pas\textbf{cén}tur,~\gredagger{}
  simul requiéscent cátu\textit{li e}\textbf{ó}rum;~\grestar{}
  et leo quasi bos cóme\textit{det} \textbf{pá}leas.
}{\trMatLecII}{10cm}
...
\textusEtTranslatio{
  ...
  super forá\textit{mine} \textbf{ás}pidis;~\grestar{}
  et in cavérna réguli
  qui ablactátus fúerit manum su\textit{am} \textbf{mit}tet.
  Non nocébunt et non occídent
  in univérso monte sancto \textbf{me}o,~\gredagger{}
  quia repléta est terra scién\textit{tia} \textbf{Dó}mini,~\grestar{}
  sicut aquæ maris ope\textit{ri}\textbf{én}tes.
  In die illa radix Iesse,
  qui stat in signum popu\textbf{ló}rum,~\gredagger{}
  ipsum gentes de\textit{preca}\textbf{bún}tur,~\grestar{}
  et erit sepúlcrum eius glo\textit{ri}\textbf{ó}sum.
}{\trMatLecIII}{10cm}
...
\noindent De Expositióne sancti Hierónymi Presbytéri in Isaíam \textit{Pro}\textbf{phé}tam.

\textusEtTranslatio{
  Et egrediétur virga de rádi\textit{ce} \textbf{Ies}se.
  Usque ad princípium visiónis, vel pónderis Babylónis, quod vidit Isaías, fílius \textbf{A}mos,~\gredagger{}
  omnis hæc prophétia de Christo est: quam per partes vólumus \textit{expla}\textbf{ná}re,~\grestar{}
  ne simul propósita atque dissérta lectóris confúndat \textit{me}\textbf{mó}riam.
  Virgam et florem de rádice Iesse ipsum Dóminum Iudǽi interpre\textbf{tán}tur:~\gredagger{}
  quod scílicet in virga regnán\textit{tis po}\textbf{tén}tia,~\grestar{}
  in flore pulchritúdo \textit{mon}\textbf{stré}tur.
}{\trMatLecIV}{10cm}
...
\textusEtTranslatio{
  ...
  huic dispensatíoni nésciens serviébat: ut dum atróci intén\textit{tus fa}\textbf{cí}nori,~\grestar{}
  ignótum sibi púerum indiscréta infántium cæde per\textbf{sé}quitur,~\gredagger{}
  annuntiátum cǽlitus dominatóris ortum insígnior ubíque fama \textit{loque}\textbf{ré}tur:~\grestar{}
  quam promptiórem ad nar\textbf{rán}dum,~\gredagger{}
  diligentiorémque faciébat et supérnæ significati\textit{ónis} \textbf{nó}vitas,~\grestar{}
  et cruentíssimi persecutóris \textit{im}\textbf{pí}etas.
  Tunc autem étiam Ægýpto Salvátor il\textbf{lá}tus est,~\gredagger{}
  ut gens antíquis erró\textit{ribus} \textbf{dé}dita,~\grestar{}
  iam ad vicínam salútem per occúltam grátiam signa\textbf{ré}tur:~\gredagger{}
  et quæ nondum eiécerat ab ánimo super\textit{stiti}\textbf{ó}nem,~\grestar{}
  iam hospítio recíperet ve\textit{ri}\textbf{tá}tem.
}{\trMatLecV}{10cm}
...
\textusEtTranslatio{
  ...
  in Magis adoratóribus Christi, vocatiónis nostræ fideí\textit{que pri}\textbf{mí}tias:~\grestar{}
  et exsultántibus ánimis beátæ spei inítia ce\textit{leb}\textbf{ré}mus.
  Exínde enim in ætérnam hereditátem cœ́pimus intro\textbf{í}re:~\gredagger{}
  exínde nobis Christum loquéntia Scripturárum arcána patué\textit{runt, et} \hbox{\textbf{vé}ritas,~\grestar{}}
  quam Iudæórum obcæcátio non récipit, ómnibus natiónibus lumen suum \textit{in}\textbf{vé}xit.
  Honorétur ítaque a nobis sacratíssimus dies, in quo salútis nostræ Auctor ap\textbf{pá}ruit:~\gredagger{}
  et quem Magi infántem veneráti sunt \textit{in cu}\textbf{ná}bulis,~\grestar{}
  nos omnipoténtem adorémus \textit{in} \textbf{cæ}lis.
  Ac sicut illi de thesáuris suis mýsticas Dómino múnerum spécies obtu\textbf{lé}runt,~\gredagger{}
  ita et nos de cór\textit{dibus} \textbf{nos}tris,~\grestar{}
  quæ Deo sunt digna, \textit{pro}\textbf{má}mus.
}{\trMatLecVI}{10cm}
...
\textusEtTranslatio{
  ...
  mittens duos de discí\textit{pulis} \textbf{su}is,~\grestar{}
  ait illi: \textit{Tu} es qui ventúrus es, an álium ex\textit{spec}\textbf{tá}mus?
  \textit{Et re}\textbf{lí}qua.
}{\trMatLecVIIa}{10cm}
...
\textusEtTranslatio{
  Visis tot signis tantís\textit{que vir}\textbf{tú}tibus,~\grestar{}
  non scandalizári quisque pótuit, sed ad\textit{mi}\textbf{rá}ri.
  Sed infidélium mens grave in illo scán\textit{dalum} \textbf{pér}tulit,~\grestar{}
  cum eum post tot mirácula morién\textit{tem} \textbf{vi}dit.
  Unde et Paulus \textbf{di}cit:~\gredagger{}
  Nos autem prædicámus Christum \textit{cruci}\textbf{fí}xum,~\grestar{}
  Iudǽis quidem scándalum, géntibus autem \textit{stul}\textbf{tí}tiam.
  Stultum quippe homínibus visum est, ut pro homínibus Auctor vitæ more\textbf{ré}tur:~\gredagger{}
  et inde contra eum homo scán\textit{dalum} \textbf{sump}sit,~\grestar{}
  unde ei ámplius débitor fíe\textit{ri} \textbf{dé}buit.
  Nam tanto Deus ab homínibus dígnius \textit{hono}\textbf{rán}dus est,~\grestar{}
  quanto pro homínibus et indígna \textit{sus}\textbf{cé}pit.
}{\trMatLecVIIb}{10cm}
...
\textusEtTranslatio{
  ...
  Beátus qui non fúerit scandali\textit{zátus} \textbf{in} me;~\grestar{}
  nisi apérta \textit{vo}ce abiectiónem mortis suæ humilitatémque \textit{sig}\textbf{ná}re?
  Ac si paténter \textbf{di}cat:~\gredagger{}
  Mira \textit{quidem} \textbf{fá}cio,~\grestar{}
  sed abiécta perpéti non \textit{de}\textbf{díg}nor.
  Quia ergo moriéndo te súbsequor, cavéndum valde est ho\textbf{mí}nibus,~\gredagger{}
  ne in me mor\textit{tem des}\textbf{pí}ciant,~\grestar{}
  qui signa ve\textit{ne}\textbf{rán}tur.
}{\trMatLecVIII}{10cm}
...
\textusEtTranslatio{
  Sed dimíssis Ioán\textit{nis dis}\textbf{cí}pulis,~\grestar{}
  quid de eódem Ioánne turbis dicat, au\textit{di}\textbf{á}mus.
  Quid exístis \textit{in} desértum \textit{vi}\textbf{dé}re?
  Arúndinem \textit{ven}to a\textit{gi}\textbf{tá}tam?
  Quod vidélicet non \textit{asse}\textbf{rén}do,~\grestar{}
  sed negán\textit{do} \textbf{ín}tulit.
  Arúndinem quippe mox ut au\textit{ra con}\textbf{tí}gerit,~\grestar{}
  in partem álteram \textit{in}\textbf{fléc}tit.
  Et quid per arúndinem, \textit{ni}si carnális ánimus de\textit{sig}\textbf{ná}tur?
  Qui mox ut favóre vel detractióne tángitur, \textit{sta}tim in partem quámlibet in\textit{cli}\textbf{ná}tur?
}{\trMatLecIX}{10cm}
...
\pars{Evangelium} \scriptura{Mt. 11, 2-10}

\noindent Léctio san\textit{cti} \textbf{E}\textit{van}\textbf{gé}lii {\textnormal{\grestar{}}} secúndum Mat\textbf{thǽ}um.

\textusEtTranslatio{
  \textit{In} \textbf{il}\textit{lo} \textbf{tém}pore:~\grestar{}
  Cum audísset Ioánnes in vínculis ópera Christi, mittens duos de \textit{dis}\textbf{cí}\textit{pulis} \textbf{su}is,~\grestar{}
  ait illi: \textit{Tu} es, qui ventúrus es, an álium ex\textit{spec}\textbf{tá}mus?
  Et respóndens Ie\textit{sus} \textbf{a}\textit{it} \textbf{il}lis:~\grestar{}
  Eúntes renuntiáte Ioánni quæ audístis et vi\textbf{dís}tis.
  Cæci vident, claudi ámbulant, leprósi mundántur, surdi áudiunt, mórtui resúrgunt, páuperes e\textit{van}\textbf{ge}\textit{li}\textbf{zán}tur:~\grestar{}
  et beátus est, qui non fúerit scandalizátus \textbf{in} me.
  Illis autem abeúntibus, cæpit Iesus dícere ad turbas de Ioánne: \textit{Quid} exístis in desértum \textit{vi}\textbf{dé}re?
  arúndinem \textit{ven}to a\textit{gi}\textbf{tá}tam?
  Sed quid \textit{ex}ístis \textit{vi}\textbf{dé}re?
  hóminem \textit{mól}libus \textit{ves}\textbf{tí}tum?
  Ecce qui móllibus vestiúntur, in dómibus \textbf{re}gum sunt.
  Sed quid \textit{ex}ístis vidére \textit{pro}\textbf{phé}tam?
  Etiam dico vobis et plus quam pro\textbf{phé}tam.
  Hic est e\textit{nim}, \textbf{de} \textit{quo} \textbf{scrip}tum est:~\grestar{}
