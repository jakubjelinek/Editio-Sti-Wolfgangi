\rubricatum{Všichni se odeberou ke křtitelnici nebo do presbytáře, podle toho, kde je vhodnější udělovat křest.
...
\rubricatum{Potom, obrácen ke křtitelnici, mimo dobu velikonoční, posvětí celebrant vodu:}
...
\rubricatum{Celebrant se dotkne pravou rukou vody a~pokračuje:}
...
\rubricatum{Celebrant vybídne rodiče a~kmotra těmito slovy:}
...
\rubricatum{Pak se jich otáže:} Chcete žít ve svobodě dětí Božích a~zříkáte se proto hříchu?

\rubricatum{Rodiče a~kmotři:} Ano.

\rubricatum{Celebrant:} Chcete, aby vás nikdy hřích neovládl,
a~zříkáte se proto všeho, co k~němu láká?

\rubricatum{Rodiče a~kmotři:} Ano.

\rubricatum{Celebrant:} Zříkáte se tedy ducha zla a~všeho, co působí a~čím se pyšní?

\rubricatum{Rodiče a~kmotři:} Ano.

\rubricatum{Potom si vyžádá celebrant od rodičů a~kmotrů trojí vyznání víry:}

Věříte v~Boha, Otce všemohoucího, Stvořitele nebe i~země?

\rubricatum{Rodiče a~kmotři:} Věřím.

\rubricatum{Celebrant:} Věříte v~Ježíše Krista, Syna jeho jediného, Pána našeho,
jenž se narodil z~Marie Panny, byl ukřižován a~pohřben, vstal z~mrtvých a~sedí po pravici Otcově?

\rubricatum{Rodiče a~kmotři:} Věřím.

\rubricatum{Celebrant:} Věříte v~Ducha svatého, svatou církev obecnou, společenství svatých,
odpuštění hříchů, vzkříšení mrtvých a~život věčný?

\rubricatum{Rodiče a~kmotři:} Věřím.

\rubricatum{Celebrant řekne:} Tak věříme. Tak věří církev. A~tuto víru vyznáváme,
a~ona je naší slávou v~Kristu Ježíši, našem Pánu.

\rubricatum{A všichni odpoví:} Amen.

\pars{}

\rubricatum{Celebrant vyzve rodinu, aby přistoupila ke křtitelnici. Táže se rodičů a~kmotrů:}
...
\rubricatum{A hned potom celebrant dítě pokřtí. Říká:}

{\color{red}N.}, já tě křtím ve jménu Otce

\rubricatum{lije vodu anebo ponoří dítě poprvé}

i~Syna

\rubricatum{lije vodu anebo ponoří dítě podruhé}

i~Ducha svatého.

\rubricatum{lije vodu anebo ponoří dítě potřetí.}
