...
{\bfseries \input{temporalia/ritusrecipiendi-\parvulum.tex} }
...
\ifparvulus
{\bfseries \input{evangelium-initium-boh.tex}}

\noindent\pars{Slova svatého Evangelia podle Marka.} \scriptura{Mk. 10, 13-16}

{\bfseries \input{evangelium2-boh.tex}
\else
{\bfseries \input{evangelium-initium.tex}}

\noindent\pars{Léctio sancti Evángelii secúndum Ioánnem.} \scriptura{Io. 19, 38-42}

{\bfseries \input{evangelium.tex}
\fi
...
\input{temporalia/oratiofidelium-\parvulum.tex}}

\sineinitiali{temporalia/terogamus.gtex}

{\bfseries \input{temporalia/oratiofidelium-2-\parvulum.tex}}
...
{\bfseries \input{temporalia/exorcismus-\parvulum.tex}

\vspace{0.7cm}

\pars{Celebratio baptismi}

\input{temporalia/celebratio-baptismi-\parvulum.tex}

\vfill

\pars{Ritus explanativi}

\input{temporalia/ritus-explanativi-\parvulum.tex}}
...
{\bfseries \input{temporalia/conclusio-ritus-\parvulum.tex}}
