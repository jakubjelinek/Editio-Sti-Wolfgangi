...
\fi
\else
\pars{Invitatorium.} \scriptura{Cf. Ps. 94, 6.7}

\vspace{-4mm}

\antiphona{D}{temporalia/inv-populusdomini.gtex}
\fi
\else
\invitatorium
\fi
...
{
\grechangedim{interwordspacetext}{0.30 cm plus 0.15 cm minus 0.05 cm}{scalable}%
\antiphona{II}{temporalia/hym-DeusDeNullo.gtex}
\grechangedim{interwordspacetext}{0.22 cm plus 0.15 cm minus 0.05 cm}{scalable}%
}
\fi
\else
...
\cuminitiali{IV}{temporalia/hym-DieiLuce.gtex}
\vspace{-3mm}
\fi
\else
\hymnuslaudes
...
\scriptura{Canticum Moysi, Dt. 32, 1-12}
...
%\ifx\laudd\undefined
%\else
%\pars{Lectio Brevis.} \scriptura{2 Petr. 3, 13-15}
%
...
%\fi
\else
\pars{Lectio Brevis.} \scriptura{Rom. 12, 14-16}

\noindent Benedícite persequéntibus; benedícite et nolíte maledícere! Gaudére cum gaudéntibus, flere cum fléntibus. Idípsum ínvicem sentiéntes, non alta sapiéntes, sed humílibus consentiéntes.
\fi
\else
\lectiobrevis
\fi
...
%\fi
\else
\pars{Responsorium breve.} \scriptura{Ps. 70, 23.24}

\cuminitiali{VI}{temporalia/resp-exsultabuntlabiamea.gtex}
\fi
\else
\responsoriumbreve
\fi
...
\fi
\else
\pars{Canticum Zachariæ.} \scriptura{Cf. Lc. 1, 79; \textbf{H424}}

\vspace{-4mm}

{
\grechangedim{interwordspacetext}{0.18 cm plus 0.15 cm minus 0.05 cm}{scalable}%
\antiphona{VIII G\textsuperscript{2}}{temporalia/ant-dirigepedesnostros.gtex}
\grechangedim{interwordspacetext}{0.22 cm plus 0.15 cm minus 0.05 cm}{scalable}%
}
...
%\fi
\else
\noindent Christi benignitátem et sapiéntiam celebrémus, ~\gredagger{} qui in ómnibus frátribus nostris, præsértim mala patiéntibus, conspiciéndum et diligéndum se trádidit. ~\grestar{} Eum instánter orémus:

\Rbardot{} Pérfice nos in caritáte, Dómine.

\noindent Resurrectiónem tuam iam mane recólimus,~\grestar{} et benefícia redemptiónis tuæ cunctis optámus.

\Rbardot{} Pérfice nos in caritáte, Dómine.

\noindent Præsta, Dómine, ut hódie testimónium de te perhibeámus,~\grestar{} et hóstiam sanctam offerámus per te Patri placéntem.

\Rbardot{} Pérfice nos in caritáte, Dómine.

\noindent Fac ut in ómnibus tuam agnoscámus imáginem,~\grestar{} et tibi in eis ministrémus.

\Rbardot{} Pérfice nos in caritáte, Dómine.

\noindent Christe, vitis vera, cuius nos pálmites sumus,~\grestar{} da nos in te manére, ut fructum multum afferámus et Deum Patrem glorificémus.
