...
\pars{Psalmus 2.} \scriptura{Ps. 96, 11}

\vspace{-4mm}

\antiphona{VIII G}{temporalia/ant-luxortaestiusto.gtex}
...
\antiphona{VIII d}{temporalia/ant-notumfecitdominus.gtex}
...
\initiumpsalmi{temporalia/ps97-initium-viii-d.gtex}

\input{temporalia/ps97-viii-C2.tex} \Abardot{}
...
\pars{Responsorium 2.} \scriptura{\Rbardot{} Io. 1, 29-30 \Vbardot{} ibid., 19; \textbf{H49}}
...
\newcommand{\preces}{\noindent Christum Dóminum, cuius grátia ómnibus homínibus appáruit,~\gredagger{} cum húmili fidúcia implorémus:

\Rbardot{} Dómine, miserére nostri.

\noindent Christe, a Patre génite ante ómnia sǽcula, splendor glóriæ eius, imágo eius substántiæ, qui verbo tuo univérsa susténtas,~\gredagger{} te rogámus, ut Evangélio tuo hunc diem vivífices.

\Rbardot{} Dómine, miserére nostri.

\noindent Christe, in hoc mundo quando venit plenitúdo témporis nate, ad salvándum humánum genus et ad liberándam creatúram univérsam,~\gredagger{} te rogámus, ut præstes ómnibus libertátem.

\Rbardot{} Dómine, miserére nostri.

\noindent Christe, Fili consubstantiális Patris, ante lucíferum génite, qui in Béthlehem natus es, ut adimpleréntur Scriptúræ,~\gredagger{} te rogámus, ut paupértas effúlgeat in Ecclésia tua.

\Rbardot{} Dómine, miserére nostri.

\noindent Christe, Deus et homo, qui Dóminus es David et fílius eius, prophetías adímplens,~\gredagger{} te rogámus, ut Israel te Messíam agnóscat.

\Rbardot{} Dómine, miserére nostri.}
\newcommand{\commemoratio}{\pars{Pro commemoratio S. Silvestri I, Papæ et Confessoris.}

\antiphona{VIII G}{temporalia/ant-silvesterbeatissimus.gtex}

\vspace{7mm}

\pars{Oratio.}

\noindent Auxiliáre, Dómine, pópulo tuo, beáti Silvéstri, papæ, intercessióne suffúlto,
\gredagger{} ut, præséntem vitam sub tua gubernatióne transcúrrens,
\grestar{} mereátur felíciter inveníre perpétuam.
