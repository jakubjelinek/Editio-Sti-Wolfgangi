...
\textusEtTranslatio{
  ...
  eam sub brevitáte transcúrrimus, quátenus eius exposítio ita nesciéntibus \textit{fi}\textit{at} \textbf{cóg}nita,~\grestar{}
  ...
  qui de diábolo ad beátum Iob ló\textit{qui}\textit{tur}, \textbf{di}cens:~\grestar{}
  Virtus eius in lumbis eius, et fortitúdo illíus in umbilíco ven\textit{tris} \textbf{e}ius.
  A principáli ígitur sexu lumbórum nómine luxúria \textit{de}\textit{sig}\textbf{ná}tur,~\grestar{}
  ...
  Sed quia minus est mala non ágere, nisi étiam quisque stúdeat et bonis opéribus insudáre, pró\textit{ti}\textit{nus} \textbf{ád}ditur:~\grestar{}
  ...
  Duo autem sunt quæ iubéntur, et lumbos restríngere, et lu\textit{cér}\textit{nas} \textbf{té}nere,~\grestar{}
  ...
  Sed et si utrúmque ágitur, restat ut quisquis ille est spe ad supérnam pát\textit{ri}\textit{am} \textbf{ten}dat,~\grestar{}
  ...
  Unde et prótinus súbditur: Et vos símiles homínibus exspectántibus dó\textit{mi}\textit{num} \textbf{su}um,~\grestar{}
